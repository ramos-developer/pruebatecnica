...
use App\Configurations\HobbieConfigurationImpl;
use App\Repositories\HobbieRepository;
use App\Http\Resources\HobbieResource;
use App\Http\Resources\HobbieResourceCollection;

class HobbieService extends AbstractService
{
    ...
    public function __construct()
    {
        ...
        $this->configuration_impl = new HobbieConfigurationImpl();
        $this->model = $this->configuration_impl->getModelName();
        $this->repository = HobbieRepository::getInstance();
    }
    ...
    public function get($id, $withResponse = false){
        ...
        $result = new HobbieResource($model);
        if($withResponse){
    ...
    public function list($input){
        ...
        $response = new HobbieResourceCollection($response);
        return $response;
    }
    ...
    public static function getInstance(){
        if(self::$__instance === null){
            self::$__instance = new HobbieService();
        }
