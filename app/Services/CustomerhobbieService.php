...
use App\Repositories\CustomerhobbieRepository;
use App\Http\Resources\CustomerhobbieResource;
use App\Http\Resources\CustomerhobbieResourceCollection;

class CustomerhobbieService extends AbstractService
{
    ...
    public function __construct()
    {
        ...
        $this->repository = CustomerhobbieRepository::getInstance();
    }
    ...
    public function get($id, $withResponse = false){
        ...
        $result = new CustomerhobbieResource($model);
        if($withResponse){
    ...
    public function list($input){
        ...
        $response = new CustomerhobbieResourceCollection($response);
        return $response;
    }
    ...
    public static function getInstance(){
        if(self::$__instance === null){
            self::$__instance = new CustomerhobbieService();
        }
