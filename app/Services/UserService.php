...
use App\Configurations\UserConfigurationImpl;
...
class UserService extends AbstractService
{
    ...
    public function __construct()
    {
        ...
        $this->configuration_impl = new UserConfigurationImpl();
    ...
    public function list($input){
        ...
        $response = new UserResourceCollection($response);
        return $response;
    }
    ...
    public static function getInstance(){
        if(self::$__instance === null){
            self::$__instance = new UserService();
        }
